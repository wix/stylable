import { createFeature, FeatureTransformContext } from './feature.js';
...
import * as STVar from './st-var.js';
import type { ElementSymbol } from './css-type.js';
import type { ClassSymbol } from './css-class.js';
import { createSubsetAst, isStMixinMarker } from '../helpers/rule.js';
import { scopeNestedSelector } from '../helpers/selector.js';
import { mixinHelperDiagnostics, parseStMixin, parseStPartialMixin } from '../helpers/mixin.js';
import { resolveArgumentsValue } from '../functions.js';
import { cssObjectToAst } from '../parser.js';
import * as postcss from 'postcss';
import postcssValueParser, { FunctionNode, WordNode } from 'postcss-value-parser';
import { fixRelativeUrls } from '../stylable-assets.js';
import { isValidDeclaration, mergeRules, utilDiagnostics } from '../stylable-utils.js';
import type { StylableMeta } from '../stylable-meta.js';
import type { CSSResolve, MetaResolvedSymbols } from '../stylable-resolver.js';
import type { StylableTransformer } from '../stylable-transformer.js';
